    ...
    lg:p-24 p-10 flex flex-col justify-center items-center gap-5 bg-center bg-cover bg-no-repeat'>
     ...
     <div className='absolute inset-0 bg-black/50'></div>
      ...
      <div className='relative z-10 flex flex-col justify-center items-center gap-5'>
        ...
        font-fakhwan font-semibold text-white lg:w-[60%] w-full text-center capitalize'>Lorem ipsum dolor sit amet.</h1>
        <p data-aos ='zoom-in' data-aos-delay='200' className='text-white lg:w-[50%] w-full text-lg text-center'>Lorem ipsum dolor sit amet 
          consectetur adipisicing elit. Adipisci vero molestiae quae harum fugiat vitae, quis vel deserunt pariatur numquam!</p>

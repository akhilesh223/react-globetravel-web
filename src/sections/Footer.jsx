...
function Footer() {
  return (
    <div id='contact' className='w-full bg-black lg:px-24 px-5 py-10 flex
     flex-col justify-center items-center gap-12'>
      ...
      lg:flex-row flex-col justify-between items-start -mt-[120px] gap-6'>
        <div className='lg:w[70%] w-full flex flex-col justify-between items-start gap-5'>
          <h1 className='text-3xl font-fakhwang font-semibold text-white text-left lg:w-[60%]
          w-full'>crafting unforgettable journays one adventure at a time</h1>
        ...
        <div className='lg:w-[30%] w-full flex flex-col justify-between items-start gap-5'>
          ...
          <div className='flex lg:flex-row flex-col gap-3 w-full'>
            <input type="text"placeholder='Enter your email' className='bg-white p-2 
      ...
      gap-10'>
        ...
        <div className='lg:w-[40%] w-full'>
          <h1 className='text-3xl font-fakhwang font-semibold'>GLOBETRAVEL</h1>
          <p className='mt-5'>Explore the world with us! Stay updated on the latest travel deals, tips, and exciting destinations by subscribing to our newsletter.</p>
          <div className='flex flex-col justify-between items-start gap-2 mt-5'>
            <div className='flex justify-start items-start gap-2'><IoMail className='text-orange-600
            text-xl'/><p>akhileshnishad287@gmail.com</p></div>
            <div className='flex justify-start items-start gap-2'><FaPhoneAlt className='text-orange-600
            text-xl'/><p>+91 799 1896 083</p></div>
          </div>
        </div>
        {/* 1st box ends */}
        ...
        <div className=' lg:w-[20%] w-full'>
          <h1 className='text-xl font-medium font-fakhwang'>Quick Link</h1>
        ...
        <div className=' lg:w-[20%] w-full'>
          ...
          <ul className=' flex flex-col justify-between items-start gap-3 mt-5'>
            <li className=' text-gray-300 hover:text-orange-600 cursor-pointer flex 
            justify-between items-center gap-2'><FaFacebook className='text-orange-600 text-xl'/> Facebook</li>
                        <li className=' text-gray-300 hover:text-orange-600 cursor-pointer flex 
            justify-between items-center gap-2'><AiFillInstagram className='text-orange-600 text-xl'/>Instagram</li>
                        <li className=' text-gray-300 hover:text-orange-600 cursor-pointer flex 
            justify-between items-center gap-2'><FaLinkedin className='text-orange-600 text-xl'/>Linkedin</li>
                        <li className=' text-gray-300 hover:text-orange-600 cursor-pointer flex 
            justify-between items-center gap-2'><FaTwitter className='text-orange-600 text-xl'/>Twitter</li>
